...
def test_list_index_bounds_can_use_input_pins_and_literals() -> None:
    graph = acherion_model.AcherionGraph(
        nodes=[
            acherion_model.AcherionNode(
                node_id='c1',
            ...
            acherion_model.AcherionNode(
                node_id='c3',
                kind='constant',
                params={'value_type': 'int', 'number_value': 3},
            ),
            acherion_model.AcherionNode(
                node_id='l1',
                kind='make_list',
                params={'arg_sources': ['c1', 'c2', 'c3']},
            ),
            acherion_model.AcherionNode(
                node_id='g1',
                kind='list_index',
                params={'source': 'l1', 'index': 'idx'},
            ),
            acherion_model.AcherionNode(
                node_id='idx',
                kind='constant',
            ...
            acherion_model.AcherionNode(
                node_id='c9',
                kind='constant',
                params={'value_type': 'int', 'number_value': 9},
            ),
            acherion_model.AcherionNode(
                node_id='s1',
                kind='list_set',
    ...
    assert preview.reference_values['g1'] == 2
    assert preview.reference_values['g2'] == [2, 3]
    assert preview.reference_values['s1'] == [1, 9, 3]
